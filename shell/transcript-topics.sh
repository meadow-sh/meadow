...
read -r -d '' USER_2 <<EOF
Could you please give me a detailed list of topics that I talked about? The list should be sorted
by relevance to the transcript, with the most relevant topics at the top of the list. The list should
have 3 sections: primary, secondary, and tertiary. Please format the response as a JSON object
that conforms to the following TypeScript interface:
